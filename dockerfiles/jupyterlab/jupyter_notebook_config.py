...
## Whether the banner is displayed on the page.
#  See also: NotebookApp.show_banner
# c.LabApp.show_banner = True
...
#  Choices: any of ['blake2b', 'sha256', 'md5', 'blake2s', 'sha3_512', 'sha512', 'sha3_224', 'sha3_384', 'sha384', 'sha3_256', 'sha1', 'sha224']
#  Default: 'sha256'
